...
document.addEventListener('DOMContentLoaded', function () {
    ...
    checkPageButton.addEventListener('click', function () {
        if (document.getElementById('input-textarea').value !== "") {
            var e = document.getElementById("hash-method");
            var value = e.options[e.selectedIndex].value;
            hash(document.getElementById('input-textarea').value, value.toString()).then((hex) => document.getElementById('output-textarea').value = hex);
...
document.addEventListener('DOMContentLoaded', function () {
    var copyOutputButton = document.getElementById('copy-btn');
